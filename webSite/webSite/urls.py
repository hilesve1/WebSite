...
urlpatterns = [
    ...
    path('password_reset_confirm/<uid64>/<token>', authViews.PasswordResetConfirmView.as_view(template_name='users/password_reset_confirm.html'), name='password_reset_confirm'),
